...
def say(text):
    ...
    if system_platform == 'darwin':
        os.system(f"say -r 300 {text}")  # Adjusted speech synthesis rate
    elif system_platform == 'linux':
        os.system(f"espeak -s 200 -v en '{text}'")  # Adjusted speech synthesis rate
    elif system_platform == 'windows':
        speaker = win32com.client.Dispatch("SAPI.SpVoice")
        speaker.Rate = 3  # Adjusted speech synthesis rate
        speaker.Speak(text)
    else:
...
if __name__ == '__main__':
    print('PyCharm')
    say("Hello, I am D3mon. Listening for voice messages.")
    ...
    while True:
        try:
            ...
            if "exit" in query or "bye" in query or "goodbye" in query:
                ...
                detect_objects_yolov8(image_path)
